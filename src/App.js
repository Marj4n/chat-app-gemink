...
firebase.initializeApp({
  apiKey: "AIzaSyDJBxsi2BiKhPfnui8ghPIDL1AEKothCW4",
  authDomain: "chat-app-geminkk.firebaseapp.com",
  projectId: "chat-app-geminkk",
  storageBucket: "chat-app-geminkk.appspot.com",
  messagingSenderId: "728906908183",
  appId: "1:728906908183:web:ebf7e1f138f045aeecd252",
  measurementId: "G-3VJ668JXS5",
});
...
function App() {
    ...
    return (
      <div className="flex items-center justify-center shadow-md h-full">
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          <h2 className="mb-2 text-3xl flex items-center">Chat app Gemink</h2>
          <p className="mb-8 text-lg text-center">
            This is a simple chat app built with React.js and Firebase.
          </p>
          <button
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a target="_blank" href="https://kvn.netlify.app/">
          <h1 className="icon" witdh={150}>
            Dev Website
          </h1>
        </a>
